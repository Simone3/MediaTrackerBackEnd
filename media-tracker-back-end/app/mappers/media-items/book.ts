...
import { BookInternal, BookFilterInternal, BookSortByInternal, BookSortFieldInternal, SearchBookCatalogResultInternal, CatalogBookInternal } from "../../models/internal/media-items/book";
import { IdentifiedBook, BookFilter, BookSortBy, BookSortField, SearchBookCatalogResult, CatalogBook } from "../../models/api/media-items/book";
